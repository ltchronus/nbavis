define(function(require, exports, module) {
    ...
    VORPED.court = function(ratio, container_selector, obj_svg) {
        ...
        var _viewBox = "0 0 " + 1130 * court_ratio + " " + 660 * court_ratio,
            _threeptstrPath_left = 'M' + 0 * court_ratio + ',' + 30 * court_ratio + 'L' + 169 * court_ratio + ',' + 30 * court_ratio + 'A' + 285 * court_ratio + ' ' + 285 * court_ratio + ' ' + 0 + ' ' + 0 + ' ' + 1 + ' ' + 169 * court_ratio + ' ' + 570 * court_ratio + 'L' + 0 * court_ratio + ' ' + 570 * court_ratio + 'Z',
            _threeptstrPath_right = 'M' + 1128 * court_ratio + ',' + 30 * court_ratio + 'L' + 959 * court_ratio + ',' + 30 * court_ratio + 'A' + 285 * court_ratio + ' ' + 285 * court_ratio + ' ' + 0 + ' ' + 0 + ' ' + 0 + ' ' + 959 * court_ratio + ' ' + 570 * court_ratio + 'L' + 1128 * court_ratio + ' ' + 570 * court_ratio + 'Z',
        ...
        this.draw = function(court_id, court_label_text) {
            ...
            var container = svg.append("g").attr("class", "court_container");
