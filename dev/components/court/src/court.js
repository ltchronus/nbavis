    ...
    this.draw = function(court_id, court_label_text) {
        this.config = {
            ...
            'court_elements':{
                ...
                'markings': {
                     // 三分线
                    'threeptstr_left':{type:'path', attrs:{'d':_threeptstrPath_left,'stroke':stroke_color_courtitems,'fill':'#fff','stroke-width':3*court_ratio}},
                    'threeptstr_right':{type:'path', attrs:{'d':_threeptstrPath_right,'stroke':stroke_color_courtitems,'fill':'#fff','stroke-width':3*court_ratio}},

                    // 绘制限制区
                    'restricted_left':{type:'rect', attrs:{x:0*court_ratio, y:204*court_ratio, width:226*court_ratio, height:192*court_ratio, stroke:stroke_color_courtitems, fill:'#fff', 'stroke-width':3*court_ratio}},
                   'restricted_right':{type:'rect', attrs:{x:900*court_ratio, y:204*court_ratio, width:226*court_ratio, height:192*court_ratio, stroke:stroke_color_courtitems, fill:'#fff', 'stroke-width':3*court_ratio}},
                   // 绘制油漆区
                    'paintleft':{type:'rect', attrs:{x:0*court_ratio, y:228*court_ratio, width:226*court_ratio, height:144*court_ratio, stroke:stroke_color_courtitems, fill:'#fff', 'stroke-width':3*court_ratio}},
                    'paintright':{type:'rect', attrs:{x:900*court_ratio, y:228*court_ratio, width:226*court_ratio, height:144*court_ratio, stroke:stroke_color_courtitems, fill:'#fff', 'stroke-width':3*court_ratio}},
                    ...
                    'center_circle':{type: 'circle', attrs:{'cx':564*court_ratio,'cy':300*court_ratio,'r':72*court_ratio,'stroke':stroke_color_courtitems,'fill':'#fff','stroke-width':3*court_ratio}},
